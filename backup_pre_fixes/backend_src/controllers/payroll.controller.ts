...
import { dhakaDayString, isMarkedHoliday, isWeeklyHoliday } from '../services/holiday.service';
...
const splitOvertime = async (
  ...
  for (const r of rows) {
    ...
    const isHolidayDay = isWeeklyHoliday(dayStr, weeklyHoliday) || (await isMarkedHoliday(dayStr));
