...
// Payroll routes
router.get('/', authorize('ADMIN', 'MANAGER', 'HR', 'FINANCE'), getPayrollRecords);
router.get('/payslip/:employeeId', authorize('ADMIN', 'MANAGER', 'HR', 'FINANCE'), exportEmployeePayslip);
router.get('/stats', authorize('ADMIN', 'MANAGER', 'HR', 'FINANCE'), getPayrollStats);
router.get('/:id', authorize('ADMIN', 'MANAGER', 'HR', 'FINANCE'), getPayrollById);
