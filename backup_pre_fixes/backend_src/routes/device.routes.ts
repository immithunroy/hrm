...
// Device routes
router.get('/', authorize('ADMIN', 'MANAGER', 'HR'), getDevices);
...
router.get('/users', authorize('ADMIN', 'MANAGER', 'HR'), listDeviceUsers);
...
router.get('/:id', authorize('ADMIN', 'MANAGER', 'HR'), getDeviceById);
