...
// Recruitment routes
router.get('/', authorize('ADMIN', 'MANAGER', 'HR'), getRecruitments);
router.get('/:id', authorize('ADMIN', 'MANAGER', 'HR'), getRecruitmentById);
...
router.get('/:recruitmentId/applicants', authorize('ADMIN', 'MANAGER', 'HR'), getApplicants);
